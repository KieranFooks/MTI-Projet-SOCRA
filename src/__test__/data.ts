...
export const testParcoursMTI : Parcours = new Parcours('MTI', 'Paris', 24, 'Master', 20000, 80, '2023-09', [testModuleMTI1, testModuleMTI2], 'Super Majeur')
export const testParcoursSRS : Parcours = new Parcours('SRS', 'Rennes', 24, 'Master', 10000, 100, '2023-02', [testModuleSRS1, testModuleSRS2], 'Majeur bof bof')
